...
## 1. 소개
* Atmega 128을 전공 수업을 통해 배웠습니다. 수업에서 배운 것을 토대로 진행한 기말고사 프로젝트로, SNS에서 아침에 못 일어나는 아들을 위해서 아버지께서 직접 만든 모닝콜 침대에서 아이디어를 얻었습니다. 침대가 올라오면서 아이를 침대 밖으로 나오게 함으로써 아이의 잠을 깨우는 것입니다. 블루투스와 Atmega 128을 이용했습니다. 
   
## 2. 기능
1) 광량 센서를 통해서 밖의 아침이 된 것을 LCD를 통해서 알립니다.
2) 부모님들께서 LCD를 확인하고 블루투스와 연결된 스마트폰을 이용해 아이의 침대를 올리는 명령을 내립니다.
...
### 2) 시연 영상
[![Video Label](http://img.youtube.com/vi/9ARxqd2wXt4/0.jpg)](https://www.youtube.com/watch?v=bV6yoHhn9GM)    
(블루투스로 통신하는 핸드폰의 영상이 여기에는 없습니다.    2년전에 만든 작품이며 프로젝트 완성 후에  하드웨어는 학교에서 지원해준 물품이기에  반납을 하게 되어 영상을 수정을 못하게 되었습니다.)
